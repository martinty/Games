...
//                              const AudioTimeStamp *time_out, void
//                              *client_data);
// #elif defined(_WIN32)
//     HWAVEOUT device;
...
//     return; AudioDeviceStart(device, audio_cb);
// #endif
...
//         snd_pcm_hw_params_set_period_size_near(handle, params, &period,
//         &dir);
...
//     if (sample_size) {
//         // Make each of the notes using a combination of sine and sawtooth
//         waves int attack = sample_size / 10; int decay = 4 * sample_size / 5;
...
//          ss->remaining > 0 && count > 0; count--, ss->data++,
//          ss->remaining--) {
